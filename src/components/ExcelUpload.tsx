    ...
    reader.onload = (evt) => {
      try {
        ...
        const identitasData = {
          ...
          jamLayanan: wsIdentitas["E15"]?.v || 0,
          menitLayanan: wsIdentitas["G15"]?.v || 0,
          hariBuka: wsIdentitas["E16"]?.v || 0,
          labSendiri: wsIdentitas["E17"]?.v || "",
          jmlTt: wsIdentitas["E18"]?.v || 0,
          
          pesertaJkn: wsIdentitas["E20"]?.v || 0,
          pendKapJkn: wsIdentitas["E21"]?.v || 0,
          pendNonkapJkn: wsIdentitas["E22"]?.v || 0,
          
          jkn_ri: wsIdentitas["E28"]?.v || 0, nonjkn_ri: wsIdentitas["G28"]?.v || 0,
          jkn_umum: wsIdentitas["E29"]?.v || 0, nonjkn_umum: wsIdentitas["G29"]?.v || 0,
          jkn_lansia: wsIdentitas["E30"]?.v || 0, nonjkn_lansia: wsIdentitas["G30"]?.v || 0,
          jkn_kia: wsIdentitas["E31"]?.v || 0, nonjkn_kia: wsIdentitas["G31"]?.v || 0,
          jkn_gigi: wsIdentitas["E32"]?.v || 0, nonjkn_gigi: wsIdentitas["G32"]?.v || 0,
          jkn_psiko: wsIdentitas["E33"]?.v || 0, nonjkn_psiko: wsIdentitas["G33"]?.v || 0,
          jkn_gizi: wsIdentitas["E34"]?.v || 0, nonjkn_gizi: wsIdentitas["G34"]?.v || 0,
          jkn_igd: wsIdentitas["E35"]?.v || 0, nonjkn_igd: wsIdentitas["G35"]?.v || 0,
          jkn_kb: wsIdentitas["E36"]?.v || 0, nonjkn_kb: wsIdentitas["G36"]?.v || 0,
          jkn_persalin: wsIdentitas["E37"]?.v || 0, nonjkn_persalin: wsIdentitas["G37"]?.v || 0,
          jkn_lab: wsIdentitas["E38"]?.v || 0, nonjkn_lab: wsIdentitas["G38"]?.v || 0,
          jkn_anc_usg: wsIdentitas["E39"]?.v || 0, nonjkn_anc_usg: wsIdentitas["G39"]?.v || 0,
          jkn_ukm: wsIdentitas["E40"]?.v || 0, nonjkn_ukm: wsIdentitas["G40"]?.v || 0,
          jkn_lain: wsIdentitas["E41"]?.v || 0, nonjkn_lain: wsIdentitas["G41"]?.v || 0,

          // D. DATA KEPEGAWAIAN (Gaji)
          gaji_dokter: wsIdentitas["F46"]?.v || 0,
          gaji_dokter_gigi: wsIdentitas["F47"]?.v || 0,
          gaji_bidan: wsIdentitas["F48"]?.v || 0,
          gaji_perawat: wsIdentitas["F49"]?.v || 0,
          gaji_perawat_gigi: wsIdentitas["F50"]?.v || 0,
          gaji_psikolog: wsIdentitas["F51"]?.v || 0,
          gaji_atlm: wsIdentitas["F52"]?.v || 0,
          gaji_farmasi: wsIdentitas["F53"]?.v || 0,
          gaji_nutrisionis: wsIdentitas["F54"]?.v || 0,
          gaji_keterapian: wsIdentitas["F55"]?.v || 0,
          gaji_sdm_lain: wsIdentitas["F56"]?.v || 0,
          gaji_non_sdm: wsIdentitas["F57"]?.v || 0,
          gaji_sp_kklp: wsIdentitas["F58"]?.v || 0,
        };
